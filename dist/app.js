...
class MudCheckFunction {
  mudCheck(node, nodes, registeredNodes, dependsMap) {
    ...
    if (functionName == 'Sink') {
      if (((_2_ = (_1_ = node.args[0]) === null || _1_ === void 0 ? void 0 : _1_.outputType) === null || _2_ === void 0 ? void 0 : _2_.status) != 'Definitely') {
    ...
    if (typechecker_1.builtins[functionName].status == "Variable") {
      if (node.args[0].outputType.constType == 'Constant') {
        ...
        node.outputType.status = (_4_ = (_3_ = node.args[0]) === null || _3_ === void 0 ? void 0 : _3_.outputType) === null || _4_ === void 0 ? void 0 : _4_.status;
      }
    } else {
...
class MudCheckChoose {
  mudCheck(node, nodes, registeredNodes, dependsMap) {
    ...
    if (((_5_ = consequent) === null || _5_ === void 0 ? void 0 : _5_.outputType.status) == 'Definitely') {
      consDef = true;
    }
    if (consDef && otherDef) {
      node.outputType.status = 'Definitely';
...
function handleCheck(consequent, dependsMap, asserts) {
  let contained = true;
  if (((_6_ = consequent) === null || _6_ === void 0 ? void 0 : _6_.nodeType) == 'Choose') {
