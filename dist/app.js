...
function parseProgram(tr) {
  ...
  let varMap = {};
  const ast = parser_1.parse(contents, varMap);
  return {
    nodes: ast.nodes,
...
// src/constantChecker.ts @190
190: function(__fusereq, exports, module){
var _1_;
var _2_;
var _3_;
function constCheckNode(node, registeredNodes) {
  checkerMap[node.nodeType].check(node, registeredNodes);
}
exports.constCheckNode = constCheckNode;
class TypeError {
  constructor(message, position) {
    this.message = message;
    this.position = position;
...
class CheckBinary {
  check(node, registeredNodes) {
    ...
    if (((_1_ = node.left.outputType) === null || _1_ === void 0 ? void 0 : _1_.constType) == 'Constant' && ((_2_ = node.right.outputType) === null || _2_ === void 0 ? void 0 : _2_.constType) == 'Constant') {
      if (node.operator == '+') {
      ...
      (_3_ = node.outputType) === null || _3_ === void 0 ? void 0 : _3_.constType = 'Non-Constant';
    }
  }
}
class CheckFunction {
